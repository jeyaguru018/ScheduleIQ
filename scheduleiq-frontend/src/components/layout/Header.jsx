  ...
  return (
    <header className="h-16 flex items-center justify-between px-8 bg-surface border-b border-outline-variant shrink-0">
      <div className="flex-1 flex items-center gap-8">
        {/* Title (for Employee view) or Search (for Manager view) */}
        <div className="relative w-96 hidden md:block">
          ...
          <input 
            ...
            className="w-full pl-10 pr-4 py-2 bg-surface-variant border border-transparent rounded-lg text-body-md focus:bg-white focus:border-primary focus:ring-1 focus:ring-primary focus:outline-none transition-all"
            onKeyDown={(e) => {
              if (e.key === 'Enter') {
